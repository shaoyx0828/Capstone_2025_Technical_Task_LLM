...
def main():
    ...
    # ✅ 初始化 wandb 并设置超参数（Prefix 无需 lora 超参）
    wandb.init(
        config={
            "batch_size": 16,
            "lr": 5e-5,
    ...
    training_args = TrainingArguments(
        output_dir="./qwen_sentiment_prefix",
    ...
    # ========= 7. 保存模型 =========
    trainer.save_model("qwen_sentiment_prefix_finetuned")
    ...
    print("✅ 模型微调完成并已保存：qwen_sentiment_prefix_finetuned")
